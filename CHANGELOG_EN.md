...
- `HTML_TITLE` (browser tab title) now defaults to `SERVICE_NAME`: rebranding requires setting just one variable. Set `HTML_TITLE` only when the tab title should differ.
