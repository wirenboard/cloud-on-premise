...
- приглашения: администратор копирует ссылку приглашения в [административной панели](#административная-панель) и передаёт её пользователю любым удобным способом — регистрация приглашённого пользователя по ссылке работает без подтверждения почты;
- сброс пароля: выполняется администратором через [административную панель](#административная-панель).
