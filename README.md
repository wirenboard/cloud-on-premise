...
обязателен, уникален и должен совпадать с `username`. Соответствующая
upstream-миграция (`users/0013`) не переносит данные сама, поэтому базу нужно
привести в порядок до миграции.
