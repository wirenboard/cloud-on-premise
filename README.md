...
Пример получения сертификата при помощи `Certbot`: [ниже](#-пример-ручной-настройки-wildcard-сертификатов)

> Если порт `443` уже занят другим веб-сервером, см. [Использование с внешним веб-сервером](#-использование-с-внешним-веб-сервером-nginxapachecaddy)
