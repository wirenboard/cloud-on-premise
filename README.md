...
HTML_TITLE         — необязательная: отдельный заголовок вкладки, если он должен отличаться от SERVICE_NAME (например, короче)
...
FOOTER_SITE_URL    — ссылка «сайт компании» в футере (по умолчанию https://wirenboard.com/)
FOOTER_SITE_LABEL_RU — подпись этой ссылки для русского языка (по умолчанию «Сайт компании Wiren Board»)
FOOTER_SITE_LABEL_EN — подпись этой ссылки для английского языка (по умолчанию «Wiren Board website»)
```
