...
Если не добавлять туда свои файлы, приложение продолжит работать с дефолтными логотипом и иконками Wiren Board.
...
Вы так же можете заменять ассерты частично
